...
- **Open:** `none` — A1–A5 and C1–C10 resolved; A6/A9 resolve as verified-downstream, named as such. **C8–C10 ratified by the user, 2026-09-11** — explicit, in response to `/peer-review` round 3's F20 (the disclosure in this block, unratified, was adequate but not sufficient on its own for C8 specifically, which reversed NFR-3's only measurable clause). The spec gate is not reopened; this ratification stands in its place for all three post-approval corrections.
